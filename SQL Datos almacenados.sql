...
SELECT v.fecha,PrecioUnitario,descripcion 
...
SELECT fecha, PrecioUnitario,dv.descripcion, p.cantidad FROM detalle_venta dv
...
GO
	...
	/****procedimiento almacenado detalle venta ****/
		...
		as 
		begin 
		insert into detalle_venta(cantidad, precioUnitario, descripcion)
		values (@cantidad,@precioUnitario,@descripcio);
		end 
			 	GO
SET ANSI_NULLS ON
GO
...
GO
		...
		set cantidad=@cantidad, PrecioUnitario=@precioUnitario, descripcion=@descripcio
